    ...
    <Sidebar collapsible="icon" className="ecommerce-sidebar">
            ...
            <SidebarMenuButton size="lg" asChild>
              <Link href="/">
                ...
                <div className="grid flex-1 text-left text-sm leading-tight">
                  <span className="truncate font-semibold">Eggshell Store</span>
                ...
                <SidebarMenuItem key={category.id}>
                  <SidebarMenuButton asChild tooltip={category.name}>
                    <Link
                      ...
                      className={pathname === `/category/${category.id}` ? 'bg-sidebar-accent text-sidebar-accent-foreground' : ''}
                    >
                      {category.id === 'apparel' && <ShoppingBag className="size-4" />}
                      {category.id === 'footwear' && <Footprints className="size-4" />}
                      {category.id === 'accessories' && <Watch className="size-4" />}
                      {category.id === 'jewellery' && <Gem className="size-4" />}
                ...
                <SidebarMenuItem key={item.title}>
                  <SidebarMenuButton asChild tooltip={item.title}>
                    ...
                    >
                      <item.icon className="size-4" />
                      <span>{item.title}</span>
                      {item.title === 'Cart' && state.itemCount > 0 && (
      ...
      <SidebarFooter>
        ...
        <div className="p-2 space-y-2">
          ...
          {state.itemCount > 0 && (
            <Button size="sm" className="w-full justify-start btn-primary-gradient" asChild>
              <Link href="/cart">
