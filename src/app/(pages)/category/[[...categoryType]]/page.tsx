...
import { useGetAllProductsBySingleCategory } from "@/query-calls/product-query";
import {
  Carousel,
  CarouselContent,
  CarouselItem,
...
export default function Page() {
  const params = useParams<{ categoryType: string }>();
  const { categoryType } = params;
  console.log(params.categoryType[0]);
  const { data: allProducts = [] } = useGetAllProductsBySingleCategory(
    categoryType[0]
  );
  ...
  // Get categories for this apparel type's products
  ...
  const categoryTitle = categoryType[0];
    ...
    <div className="space-y-8">
      ...
      <div className="text-center space-y-6">
        ...
        <div>
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-6">
            Discover our collection of {categoryTitle} products
          </p>
      ...
      <div className="text-center pt-8">
        <Button variant="outline" asChild>
          <Link href="/apparel">&larr; Back to All Apparel</Link>
        </Button>
      </div>
    </div>
  );
