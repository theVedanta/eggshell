        ...
        <div className="space-y-12">
            ...
            <div className="text-center space-y-4">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                    Discover premium brands that define modern fashion and
                    lifestyle. Each brand represents quality, innovation, and
                    timeless style.
                </p>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div className="text-center">
                        <div className="text-3xl font-bold text-primary mb-2">
                            {brands.reduce(
                                (sum, brand) =>
                                    sum + getProductsByBrand(brand.name).length,
                                0
                            )}
                            +
                        </div>
            ...
            <section className="bg-gradient-to-r from-primary to-primary/90 text-primary-foreground rounded-xl p-8 text-center">
                ...
                <p className="text-primary-foreground/90 mb-6 max-w-2xl mx-auto">
                    Be the first to know about new brand partnerships, exclusive
                    collections, and special collaborations.
                </p>
