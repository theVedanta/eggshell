...
export default function NotFound() {
  return (
    <div className="flex -z-10 items-center justify-center w-full flex-col min-h-screen">
      <h1 className="bg-clip-text mb-16 text-transparent text-center bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-8xl md:text-7xl lg:text-8xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
        <TextHoverEffect text="404" automatic />
      </h1>
      <div className="absolute top-[350px] flex items-center justify-center flex-col">
